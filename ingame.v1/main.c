...
#define N 100
    ...
    int main(int argcs, char *args[])
    {
       ...
       imagen1= SDL_LoadBMP("menuimg/randomaze_bueno.bmp");
        imagen2= SDL_LoadBMP("menuimg/opcionesradomaze.bmp");
        imagen3= SDL_LoadBMP("menuimg/dificultadrandomaze.bmp");
        imagen4= SDL_LoadBMP("menuimg/personajes.bmp");
                        ...
                        while (SDL_PollEvent(&event)!=0)
                        {
                            ...
                            else if( event.type == SDL_MOUSEBUTTONDOWN)
                            {
                                if(x<573 && y> 491 && x>298 && y<588){
                                    ...
                                    jugar(&principal,dificultad, personaje);
            ...
            case 1: //Jugar
                {
                    while (momento == 1)
                    {
                        ...
                        while (SDL_PollEvent(&event)!=0)
                        {
                            ...
                            // Se inicia la funci�n de jugar; Si es que no se a pulsado quit.
                        }
                    }
                }
                break;

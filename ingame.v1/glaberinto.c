...
SDL_Surface *aux;
    ...
    aux = SDL_LoadBMP( "img/personaje1.bmp" );
    if (aux == NULL){
        printf("error al cargar imagen: personaje.bmp");
        return 0;
    }
    *personaje = SDL_ConvertSurface( aux, principal->format, 0 );
    SDL_SetColorKey(*personaje, SDL_TRUE, SDL_MapRGB(principal->format, 255,255,255));
    ...
    *fondo = SDL_ConvertSurface( aux, principal->format, 0 );
